...
Datomic Free is provided under the terms of the
[Datomic Free End User License Agreement](https://www.datomic.com/datomic-free-edition-license.html),
a copy of which is included in this repository in the `DATOMIC_LICENSE` file.
